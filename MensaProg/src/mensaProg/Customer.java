...
{		
	...
	public void add(String vorname, String nachname, String pwort)	//Methode um einen neuen Kunden hinzuzuf�gen
	{
		...
		try {
			Statement	stmt = conn.createStatement();	//ein neues SQL Statement wrid einstellt
			stmt.execute("INSERT INTO kunden{vorname, nachname, pwort, nutzername} VALUES {" + vorname + "," + nachname +"," + pwort + "," + vorname +"."+ nachname +" }");	//ein SQL Statement wird durchgeführt um den Kontostand zu verringern
