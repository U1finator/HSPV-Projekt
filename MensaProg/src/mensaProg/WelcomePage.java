...
public class WelcomePage extends JPanel{
	...
	WelcomePage(Kunde kunde, MainGui2 mg) {
		...
		bankBalanceLabel.setText("Kontostand: "+ customer.getKontostand(kunde.getUsername())+"0€"); //0€ als ergänzung, damit der Kontostand in akzeptabeler Form angezeigt wird
